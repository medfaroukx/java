...
public class ListEventController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TableColumn<Date, String> xdate;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        xdate.setCellValueFactory(cellData ->new SimpleStringProperty(dateFormat.format(cellData.getValue().getDate())));
    ...
    private void modifier_User(ActionEvent event) {
        ...
        int id = Integer.parseInt(String.valueOf(xtable.getItems().get(myIndex).getId()));
            ...
            crud.modifierEvenement( id, nb_part, nom_even, desc_event, categorie_even, image_even, date);
